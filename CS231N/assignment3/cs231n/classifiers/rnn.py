...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        h0, cache_affine_1 = affine_forward(features, W_proj, b_proj)
        ...
        dW_embed = word_embedding_backward(dx_rnn, cache_word_embed)
        dfeatures, dW_proj, db_proj = affine_backward(dh0, cache_affine_1)
    ...
    def sample(self, features, max_length=30):
        ...
        for t in range(max_length):
            word_embed = word_embedding_forward(prev_word, W_embed)
            if self.cell_type == "rnn":
                h0 = rnn_step_forward(word_embed, h0, Wx, Wh, b)
        scores = temporal_affine_forward(h0, W_vocab, b_vocab)
