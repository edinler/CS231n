...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        cache = {}
        dout, cache["conv_relu_pool"] = conv_relu_pool_forward(X, self.params["W1"], self.params["b1"], conv_param, pool_param)
        dout, cache["affine_relu"] = affine_relu_forward(dout, self.params["W2"], self.params["b2"])
        scores, cache["affine"] = affine_forward(dout, self.params["W3"], self.params["b3"])
